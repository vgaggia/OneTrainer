from modules.model.Krea2Model import Krea2Model, convert_krea2_lora_state_dict_to_onetrainer
...
class Krea2LoRASetup(
    ...
    def setup_model(
        ...
        if model.lora_state_dict:
            state_dict = convert_krea2_lora_state_dict_to_onetrainer(model.lora_state_dict)
            model.transformer_lora.load_state_dict(state_dict)
...
factory.register(BaseModelSetup, Krea2LoRASetup, ModelType.KREA_2, TrainingMethod.LORA)
