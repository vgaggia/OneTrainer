...
class TrainConfig(BaseConfig):
    ...
    # checkpointing / offloading moved per-component upstream (#1476); these two have no
    # per-component equivalent and stay global
    async_offloading: bool
    activation_offload_compression: bool
    quantized_weight_training: bool
    ...
    def default_values() -> 'TrainConfig':
        ...
        data.append(("quantized_weight_training", False, bool, False))
